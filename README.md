...
<head>
    ...
    <style>
        ...
        #game-container {
            ...
            width: 100%;
            max-width: 400px;
            height: 70vh; /* Aumentei um pouco para caber os botões confortavelmente */
        ...
        .note { position: absolute; width: 45px; height: 45px; display: flex; justify-content: center; align-items: center; font-size: 1.3rem; font-weight: bold; border-radius: 10px; top: -50px; }
        
        .active { transform: scale(1.15); background: white !important; color: black !important; }

        /* AJUSTE DOS BOTÕES DENTRO DO CONTAINER */
        #mobile-controls { 
            display: none; 
            position: absolute;
            bottom: 20px;
...
<body>
    ...
    <div id="game-container">
        ...
        <!-- BOTÕES AGORA DENTRO DO CONTAINER -->
    ...
    <script>
        ...
        function createNote() {
            ...
            const move = setInterval(() => {
                ...
                pos += (speed * 5); // Velocidade ajustada para cair
                note.style.top = pos + 'px';
                
                // Se passar do ponto de acerto (perto dos botões)
                if (pos > (document.getElementById('game-container').offsetHeight)) {
        ...
        function handleInput(laneIndex) {
            ...
            notes.forEach(note => {
                ...
                // O acerto agora é detectado na parte de cima (perto do receptor original)
                // Se você quiser que o acerto seja nos botões de baixo, avise-me!
